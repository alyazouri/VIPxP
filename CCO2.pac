function FindProxyForURL(url, host) {
  ...
  // ❌ قائمة الحظر الشاملة - كل العالم مع استثناءات دقيقة للأردن فقط
  var BLOCKED_REGIONS_IPV4 = [
    // ========== أوروبا ==========
    ["2.0.0.0", "255.0.0.0"],
    ["31.0.0.0", "255.0.0.0"],
    
    // 37.x.x.x - استثناء الأردن فقط
    ...
    // 85.x.x.x - استثناء السعودية الشمال
    ...
    // 149.x.x.x - استثناء العراق
    ["149.0.0.0", "255.128.0.0"],
    ["149.128.0.0", "255.128.0.0"],
    
    ["151.0.0.0", "255.0.0.0"],
    
    // 176.x.x.x - استثناء الأردن ولبنان
    ...
    // 185.x.x.x - استثناء الأردن وفلسطين والشام والعراق والكويت
    ...
    // 188.x.x.x - استثناء الأردن وفلسطين والسعودية
